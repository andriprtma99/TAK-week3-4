...
WebUI.click(findTestObject('Page Home Login/span_Logout'))

WebUI.waitForElementPresent(findTestObject('Page_Login/mat-label-login'), 0)

WebUI.verifyElementVisible(findTestObject('Page_Login/mat-label-login'))

WebUI.verifyElementVisible(findTestObject('Page_Login/span_label-NewUser'))
